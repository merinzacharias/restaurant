...
const AboutSection = () => {
  return (
    <section className='relative pt:15 md:pt-18 lg:pt-20 flex justify-center items-center'>
        ...
        <div className='flex flex-col justify-center items-center gap-5 md:gap-15'>
          <div>
            <h3 className='Inter-SemiBold text-[23px] lg:text-[35px] py-8 md:py-0'>About The Company</h3>
          </div>
          <div className='mx-auto'>
            <div className='flex flex-col sm:flex-row justify-between items-center mx-6 md:mx-18 lg:mx-30 xl:mx-auto gap-15'>
